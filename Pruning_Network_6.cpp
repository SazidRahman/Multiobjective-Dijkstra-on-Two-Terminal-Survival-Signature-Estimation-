...
// ---- PARAMETERS -------------------------------------------------------------
const int V = 10;              // Total number of nodes
...
const int m2 = 3;            // Number of nodes in the second group/class of nodes
...
// Either assign the nodes to each class "manually" or following the piece of code below
    ...
    std::vector<int> class_1 = {2, 3, 4};
    std::vector<int> class_2 = {5, 6, 7};
    std::vector<int> class_3 = {8, 1};
