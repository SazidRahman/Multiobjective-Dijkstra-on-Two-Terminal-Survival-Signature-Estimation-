...
void signature_estimation(vector<int> group_1, vector<int> group_2, vector<int> group_3, vector<int> group_4, Graph g, int m1, int m2, int m3, int m4, int v, int V);

void print_signature(Graph g, int m1, int m2, int m3, int m4);

double Weibull(double t, double k, double lambda);

vector<double> reliability_function (int m1, int m2, int m3, int m4);
...
// Assigns the first m1 even nodes to the first class and the remaining m2 nodes to the second class
    ...
    signature_estimation(group_1, group_2, group_3, group_4, g, m1, m2, m3, m4, v, V);
